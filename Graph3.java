...
public class Graph3 extends Graph {
    ...
    /**
     * Constructor. Creates an instance of this Graph3 class which consists of 4 Nodes.
     * 
    ...
    public Graph3(String node_col, String font_col, String n1_data, String n2_data, String n3_data, String n4_data) {
    ...
    /**
     * Method creating a GameArena specifically for this Graph3 class.
    ...
    public void showGraph3() {
        ...
        n2 = new Node(n2_data, 250, 275, node_col);
        n3 = new Node(n3_data, 400, 450, node_col);
        n4 = new Node(n4_data, 550, 275, node_col);
        ...
        general_info = new Text("This is Graph3. \nThis graph is directed and has 4 nodes.", 100, 600, 20, font_col);
        ...
        this.addOptions(arena_graph3, exit, exit_text, graph_info, info_text);
        arena_graph3.update();
